...
class CalculationForm(forms.Form):
    ...
    Q4 = forms.FloatField(label='不合格になったときに発生する単位数あたりの損失額を記入して下さい。')
    Q5 = forms.FloatField(label='１回の計測にかかる平均コストを記入して下さい。')
    Q6 = forms.FloatField(label='１回の調整にかかる平均コストを記入して下さい。')
